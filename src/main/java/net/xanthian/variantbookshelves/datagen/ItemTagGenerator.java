...
public class ItemTagGenerator extends FabricTagProvider.ItemTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup arg) {
        ...
        getOrCreateTagBuilder(ItemTags.NON_FLAMMABLE_WOOD)
                ...
                .addOptional(new Identifier("variantcraftingtables:bls_herringbone_charred_bookshelf"))
                .addOptional(new Identifier("variantcraftingtables:bls_herringbone_crimson_bookshelf"))
                .addOptional(new Identifier("variantcraftingtables:bls_herringbone_warped_bookshelf"))
